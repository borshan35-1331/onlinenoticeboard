...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="images/mosque5.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
    <div class="item">
      <img src="images/mosque6.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
	 ...
	 <div class="item">
      <img src="images/mosque7.jpg" alt="...">
      <div class="carousel-caption">
        ...
      </div>
    </div>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2></h2>
		Welcome to our online notice board to get the notices fastest.";
		}
		?>
  ...
  <div class="panel-heading">News of the day</div>
  <div class="panel-body">
    This is the best website where
	you can get notices before others.
  </div>
</div>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="#"> Developed by  MOKARRAM & TAHSIN</a></li>
